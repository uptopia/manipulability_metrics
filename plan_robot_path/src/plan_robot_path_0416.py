...
class PlanRobotPath(object):
    ...
    def __init__(self):
        ...
        self.pose_marker_pub = rospy.Publisher("pose_marker", Marker, queue_size=10)
        self.trajectory_pub = rospy.Publisher('traject', Marker, queue_size=10)
    ...
    def dlo_cloud_cb(self, dlo_cloud_msg):
        ...
        if np.array_equal(self.base_H_DLOobj, np.identity(4)):
            ...
            ros_dlo_cloud_inRobot = self.convertCloudFromOpen3dToRos(o3d_dlo_cloud_inRobot, frame_id='link_0')#'panda_link0')
    ...
    def plan_robot_path_cb(self, pose_msg):
        ...
        try:
            ...
            (trans, quaternion) = self.listener.lookupTransform('/link_1', '/dlo_grasp_1', rospy.Time(0))
        ...
        marker = Marker()
        marker.header.frame_id = 'link_1'#'/panda_link0'
        ...
        if plan[1].joint_trajectory.points:  # True if trajectory contains points
            ...
            # https://blog.csdn.net/learning_tortosie/article/details/103136707
            traject_marker = Marker()
            traject_marker.header.frame_id = 'link_1'#'/panda_link0'
            traject_marker.header.stamp = rospy.Time.now()
            traject_marker.ns = 'points_and_lines'
            traject_marker.type = Marker.LINE_STRIP
            traject_marker.action = Marker.ADD

            traject_marker.scale.x = 0.08
            traject_marker.scale.y = 0.08
            traject_marker.scale.z = 0.08

            traject_marker.pose.orientation.x = 0.0
            traject_marker.pose.orientation.y = 0.0
            traject_marker.pose.orientation.z = 0.0
            traject_marker.pose.orientation.w = 1.0

            traject_marker.pose.position.x = 0.0
            traject_marker.pose.position.y = 0.0
            traject_marker.pose.position.z = 0.0

            traject_marker.id = 0
            
            traject_marker.color.r = 1.0
            traject_marker.color.g = 0.0
            traject_marker.color.b = 0.0
            traject_marker.color.a = 1.0

            traject_marker.points = []
            ...
            self.trajectory_pub.publish(traject_marker)       
