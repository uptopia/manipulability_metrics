...
class CheckMScore():
    ...
    def __init__(self):
        super(CheckMScore, self).__init__()

        print('=========CheckMScore=======')

        moveit_commander.roscpp_initialize(sys.argv)
        rospy.init_node("CheckMScore", anonymous=True)

        self.robot = moveit_commander.RobotCommander()

        self.group_name = rospy.get_param('/check_mscore/group_name')#"manipulator"
        self.base_frame = rospy.get_param('/check_mscore/base_frame')#"base_link"
    ...
    def compute_IK(self, chain, target_pose):
        '''
        Inverse Kinematics
        '''
    ...
    def calculate_mscore_from_joints(self, joint_angles):
        ...
        # Set Target Pose
        target_poseInCam = [pp[0], pp[1], pp[2], rr[0], rr[1], rr[2]]

        PyKDL.Frame inverse

        target_poseInBase = [pp[0], pp[1], pp[2], rr[0], rr[1], rr[2]]
